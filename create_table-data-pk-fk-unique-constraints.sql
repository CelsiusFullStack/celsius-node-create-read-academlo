...
-- Table structure for users_courses_master
...
COMMENT ON COLUMN users_courses_master.id_user_course IS '//create funtion uuid_in((md5((random())::text))::cstring)';
--CREATE EXTENSION "pgcrypto"; or CREATE EXTENSION IF NOT EXISTS "uuid-ossp"; for generation uuid

-- Table structure for users_courses_details
...
-- Key PK FK an uniques structure for table categories
...
-- Key PK FK an uniques structure for table levels
...
-- Key PK FK an uniques structure for table courses
...
-- Key PK FK an uniques  structure for table roles
...
ALTER TABLE videos ADD CONSTRAINT courses_videos_id_course_rol_fkey FOREIGN KEY (id_course) REFERENCES courses (id_course) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- Key PK FK an uniques  structure for table users
...
-- Key PK FK an uniques  structure for table users_courses_master
...
-- Key PK FK an uniques  structure for table users_courses_details
...
-- Permision Batch Insert DEFERRED pk, fk, CONSTRAINTS and uniques handle Error in Bact Insertions
ALTER TABLE users DISABLE TRIGGER ALL;
ALTER TABLE categories DISABLE TRIGGER ALL;
ALTER TABLE roles DISABLE TRIGGER ALL;
ALTER TABLE levels DISABLE TRIGGER ALL;
ALTER TABLE courses DISABLE TRIGGER ALL;
ALTER TABLE videos DISABLE TRIGGER ALL;
ALTER TABLE users_courses_master DISABLE TRIGGER ALL;
ALTER TABLE users_courses_details DISABLE TRIGGER ALL;
...
INSERT INTO users_courses_details VALUES ('718505ad-8ece-ee48-f4e2-559afa5d2877', 'fb40a75b-0594-5fc1-6d8a-adb8e3158dc1', 'f');
INSERT INTO users_courses_details VALUES ('04419e91-a1c3-abd5-741d-1168bcf75e7d', '55902ade-f3a3-f06c-a7f2-1f0e8212324f', 'f');
INSERT INTO users_courses_details VALUES ('04419e91-a1c3-abd5-741d-1168bcf75e7d', '92656a32-561b-cd9d-af59-54ed28857efe', 'f');
INSERT INTO users_courses_details VALUES ('04419e91-a1c3-abd5-741d-1168bcf75e7d', '47ce8799-b121-d334-a4a3-46eb3caf1bd8', 'f');
INSERT INTO users_courses_details VALUES ('718505ad-8ece-ee48-f4e2-559afa5d2877', '9b5ccb1c-aaf6-b37e-a9ab-553b050b5270', 'f');
INSERT INTO users_courses_details VALUES ('04419e91-a1c3-abd5-741d-1168bcf75e7d', '79b5e085-520e-bd87-746d-ead5cbf31ab2', 'f');
